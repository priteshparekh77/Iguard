...
public class AddContact extends Activity implements OnClickListener {
	...
	private DatabaseManager contactHelper;
	...
	public void onClick(View v) {
		...
		contactHelper = new DatabaseManager(AddContact.this);
		if (v.getId() == R.id.btnAddContact) {
			if (edtContactName.getText().toString().equals("")
				...
				contactHelper.addRow(edtContactName.getText().toString(), edtContactNumber
								.getText().toString());
